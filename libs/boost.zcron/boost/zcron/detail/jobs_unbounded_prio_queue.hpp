...
#ifndef BOOST_ZCRON_DETAIL_JOBS_UNBOUNDED_PRIO_QUEUE_H_
#define BOOST_ZCRON_DETAIL_JOBS_UNBOUNDED_PRIO_QUEUE_H_
...
namespace boost {
  namespace zcron {
    namespace detail {
      ...
      class jobs_unbounded_prio_queue {
       public:
        jobs_unbounded_prio_queue()
          : m_mutex(),
            m_waiter(),
            m_queue(),
            m_num_blocked(0),
        ...
        virtual ~jobs_unbounded_prio_queue() { shutdown(); }
       ...
       private:
        ...
        std::priority_queue<ObjectType, ContainerType, CompareType> m_queue;
        unsigned int m_num_blocked;
        bool m_deactivated;
        bool m_deactivated_now;

        // noncopyable
        jobs_unbounded_prio_queue(const jobs_unbounded_prio_queue&);
        void operator=(const jobs_unbounded_prio_queue&);
      };
    }  // namespace detail
  }  // namespace zcron
}  // namespace boost
#endif  // BOOST_ZCRON_DETAIL_JOBS_UNBOUNDED_PRIO_QUEUE_H_
